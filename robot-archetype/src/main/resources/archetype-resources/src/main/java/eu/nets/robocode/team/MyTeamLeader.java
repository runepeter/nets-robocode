...
public class ${artifactId}Leader extends TeamLeader
{
    ...
    private class DodgeBehaviour implements Behaviour
    {
        public void doIt()
        {
            ...
            waitFor(new TurnCompleteCondition(eu.nets.robocode.team.${artifactId}Leader.this));
            behaviourStack.pop();
        }
    }
