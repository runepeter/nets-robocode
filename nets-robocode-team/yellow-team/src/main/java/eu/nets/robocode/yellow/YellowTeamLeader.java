package eu.nets.robocode.yellow;
...
public class YellowTeamLeader extends TeamLeader
{
    ...
    private class DodgeBehaviour implements Behaviour
    {
        public void doIt()
        {
            ...
            waitFor(new TurnCompleteCondition(YellowTeamLeader.this));
            behaviourStack.pop();
        }
    }
